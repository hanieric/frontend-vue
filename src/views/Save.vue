...
const draft = useDraftStore().draft;
if (draft) {
  inputKeterangan.value = draft.pengeluaran;
...
watch(inputKeterangan, (newValue) => {
  useDraftStore().updateDraft(toData());
});
...
<template>
  <div class="flex items-center justify-center bg-gray-100">
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
      ...
      <div class="mb-6">
        <label for="inputJumlah" class="block text-gray-700 font-semibold mb-2"
        ...
        <div class="flex-2 relative w-full" id="inputTipe">
          ...
          >
            ...
            <div
              ...
              :class="{ 'bg-blue-50 font-semibold': inputTipe === 'pemasukan' }"
            >
              Pemasukan
            </div>
          </div>
      ...
      />
      <div class="mb-6">
        <label for="inputTanggal" class="block text-gray-700 font-semibold mb-2"
          >Tanggal</label
        >
        <button
          type="button"
      ...
      <button
        @click="handlePost"
        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition mt-6 mb-4"
      >
        SAVE
      </button>
    </div>
